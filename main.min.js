...
hamburger.addEventListener('click', toggleMenu);;var video = document.getElementById('video'),
...
new Accordeon('#products-m');;const findBlockByAlias = alias => {
